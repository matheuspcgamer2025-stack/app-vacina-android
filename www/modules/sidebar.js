...
import { alterarSenhaUsuarioAtual, excluirContaUsuarioAtual, encerrarSessaoUsuarioAtual } from './auth.js';
import { appConfirm } from './dialogs.js';
import { formatarDataBr as formatarDataBrDayjs } from './dayjs.js';
...
export function inicializarSidebar() {
    ...
    document.getElementById('menu-sair')?.addEventListener('click', async () => {
        ...
        if (confirmar) {
            await encerrarSessaoUsuarioAtual();
